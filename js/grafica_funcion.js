...
<?php if( $btn_colabora_p_1 || $btn_colabora_p_2 ) { ?>
    ...
    <?php if( $btn_colabora_p_1 > 0 ) { ?>
        capa_aviso += "<p class='text-center'>Falta información sobre el desempleo de la profesión<br>";
    ...
    <?php if( $btn_colabora_p_2 > 0 ) { ?>
        capa_aviso += "<p class='text-center'>Falta información sobre el desmpleo de la profesión<br>";
