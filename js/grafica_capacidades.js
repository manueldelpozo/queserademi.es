...
$btn_colabora_c_1=0;$btn_colabora_c_2=0; 
function imprimirSeriesCap($filas, $btn_colabora) {
...
$('#container_capacidades').highcharts({
    ...
    tooltip: {
        shared: true,
        headerFormat: '<strong>{point.key}</strong><br>{point.descripcion}<br>',
        pointFormat: '<span style="color:{series.color}">{series.name}: <strong>{point.y:,.0f}</strong><br/>',
        formatter: function() {
            var descripciones = {
            ...
            //this.series['descripcion'] = descripciones[this.x.replace(/ /g,"_").latinize()];
            this.x = descripciones[this.x.replace(/ /g,"_").latinize()];
            //console.log(this);
        }      
    },
    credits: {
    ...
    series: [{  
        ...
        data: [
        <?php imprimirSeriesCap($filas_capacidades[0], $btn_colabora_c_1); ?>
        ...
        <?php if( is_null($filas_capacidades[0]['c_objetivos']) || $filas_capacidades[0]['c_objetivos'] == 0 ) {echo 0;$btn_colabora_c_1+=16;} else {echo $filas_capacidades[0]['c_objetivos'];} ?>,
        <?php if( is_null($filas_capacidades[0]['c_persuasion']) || $filas_capacidades[0]['c_persuasion'] == 0 ) {echo 0;$btn_colabora_c_1+=32;} else {echo $filas_capacidades[0]['c_persuasion'];} ?>
        */
        ],
        ...
        data: [
        <?php imprimirSeriesCap($filas_capacidades_dos[0], $btn_colabora_c_2); ?>
        ...
        <?php if( is_null($filas_capacidades_dos[0]['c_objetivos']) || $filas_capacidades_dos[0]['c_objetivos'] == 0 ) {echo 0;$btn_colabora_c_2+=16;} else {echo $filas_capacidades_dos[0]['c_objetivos'];} ?>,
        <?php if( is_null($filas_capacidades_dos[0]['c_persuasion']) || $filas_capacidades_dos[0]['c_persuasion'] == 0 ) {echo 0;$btn_colabora_c_2+=32;} else {echo $filas_capacidades_dos[0]['c_persuasion'];} ?>
        */
        ],
