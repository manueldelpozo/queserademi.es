...
try{
	...
	if ($pdo->query($sql_insert)) {
		...
		echo "<table border='2px solid'><tr><td>id</td><td>cod</td><td>f_nombre_ppal</td><td>f_nombre_alt</td><td>f_descripcion</td><td>duracion_academica</td><td>duracion_real</td><td>acceso</td><td>nivel</td><td>ultima_actualizacion</td></tr>";
